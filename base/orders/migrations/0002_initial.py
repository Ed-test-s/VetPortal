...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='orderitem',
            name='pharmacy_medicine',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='order_items', to='pharmacies.pharmacymedicine', verbose_name='Лекарство в аптеке'),
        ),
        migrations.AddIndex(
            model_name='cartitem',
